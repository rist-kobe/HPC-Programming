# C++ class with OpenACC: routine directives and (a bad way of) overloading arithmetic operators
* Author:   Yukihiro Ota (yota@rist.or.jp)
* Last update: March 30th 2025

## Instruction: Compile and Run
1. Source codes are in `src`. This sample contains only C++ source files.
