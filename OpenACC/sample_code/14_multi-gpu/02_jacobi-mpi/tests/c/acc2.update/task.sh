...
#mpiexec --npernode 1 --np ${ND} --bind-to core bash -c '\
#hostname &>topo.dat.${OMPI_COMM_WORLD_RANK} &&\
#nvidia-smi topo -m &>> topo.dat.${OMPI_COMM_WORLD_RANK}' 

### Load module
BINDIR=../../../src/c/acc2.update
EXE=${BINDIR}/run.x
