...
int main (int argc, char **argv)
{
...
#endif
    nrmsq_loc = 0.0;
    #pragma acc data copyin(phie[0:nx_loc*ny_loc],rho[0:nx_loc*ny_loc]) \
    copyout(phio[0:nx_loc*ny_loc]) copy(nrmsq_loc)
    #pragma acc kernels
  ...
  if( coords[1] == 0 || coords[1] == npy-1) {
    #pragma acc data copy(phio[0:nx_loc*ny_loc]) 
    #pragma acc kernels
...
#endif
    #pragma acc data copyin(phio[0:nx_loc*ny_loc]) copyout(phie[0:nx_loc*ny_loc])
    #pragma acc kernels
