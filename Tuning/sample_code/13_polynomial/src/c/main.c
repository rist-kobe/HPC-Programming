 ...
 * Remark:           This code is written according to c99 standard.
...
int main ( int argc, char* argv[] )
{
  ...
  printf("Description:  This code is written by C99 standard.\n") ;
  printf("[setup]\n") ;
  ...
  flop = 2.0*ndim ;
  mem  = 3.0*8.0*ndim ; /* setting less than L2 cache is preferable */
  printf("[run] 1 FMA\n") ;
