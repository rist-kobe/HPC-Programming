...
2. On Fortran: Examine the role of `!$` at the start of statements. Checking whether the program compiles without an OpenMP activation flag (e.g., `-fopenmp`) will help you understand how the compiler treats these OpenMP sentinel lines.
